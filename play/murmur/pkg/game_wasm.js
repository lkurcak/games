 ...
 * @returns {any}
 */
export function check_word(letters, word) {
    const ptr0 = passStringToWasm0(letters, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(word, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.check_word(ptr0, len0, ptr1, len1);
    return ret;
}
...
export function generate_puzzle() {
    const ret = wasm.generate_puzzle();
    return ret;
}
 ...
 * @returns {any}
 */
export function get_letter_stats(letters, found_words) {
    const ptr0 = passStringToWasm0(letters, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.get_letter_stats(ptr0, len0, found_words);
    return ret;
}
 ...
 * @returns {any}
 */
export function get_puzzle_stats(letters) {
    const ptr0 = passStringToWasm0(letters, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.get_puzzle_stats(ptr0, len0);
    return ret;
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('game_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
